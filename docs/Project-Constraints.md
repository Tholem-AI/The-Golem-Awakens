...
| File size | ~2655 lines, ~108 KB | Single-file constraint |
...
| Section 1.5 | Shared utility functions (19 helpers) — between Setup/Constants and Chamber Data. Added easeOutQuint, lerp, smoothStep, getEndingGlyphState for ending sequence smoothing. | Section 1.5 |
