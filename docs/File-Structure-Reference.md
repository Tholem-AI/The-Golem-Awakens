...
GOLEM_GAME/
  ...
  golem.html                # Single-file HTML5 game (~2026 lines, 12 sections + ending animation, ~75 KB)
...
|| `docs/Visual-Story-Design.md` | tholem.ai theming spec, narrative tables, palette/contrast guardrails, Phases 1-10b checklist, code map. Phases 1-5.6 (+4.5) implemented. Glyph ordering and ending animation bugs fixed. |
