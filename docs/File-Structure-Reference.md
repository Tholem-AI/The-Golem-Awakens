...
GOLEM_GAME/
  ...
  golem.html                # Single-file HTML5 game (~2561 lines, 13 sections + sound engine, ~104 KB)
...
| `docs/Project-Constraints.md` | Stack, runtime constraints (sim timing, wall-clock ending, pace toggle), design constraints, assumptions. |
