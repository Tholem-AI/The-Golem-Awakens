...
GOLEM_GAME/
  ...
  golem.html                # Single-file HTML5 game (~2149 lines, 12 sections + ending animation, ~88 KB)
...
|| `docs/Visual-Story-Design.md` | tholem.ai theming spec, narrative tables, palette/contrast guardrails, Phases 1-10b checklist, code map. Phases 1-8 implemented (palette, Hebrew glyphs, runes, geometry, movement polish, ending, HUD, title menu, pause menu). Glyph ordering and ending animation bugs fixed. |
